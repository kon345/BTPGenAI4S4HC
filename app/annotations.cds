using { henryLin0610_STUDENTG20Srv } from '../srv/service.cds';

annotate henryLin0610_STUDENTG20Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate henryLin0610_STUDENTG20Srv.CustomerMessage with {
  ID @UI.Hidden 
};
annotate henryLin0610_STUDENTG20Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate henryLin0610_STUDENTG20Srv.CustomerMessage with {
...
annotate henryLin0610_STUDENTG20Srv.CustomerMessage with @UI.LineItem: [
...
annotate henryLin0610_STUDENTG20Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate henryLin0610_STUDENTG20Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate henryLin0610_STUDENTG20Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
