...
translation
 * @Before(event = { "READ" }, entity = "henryLin0610_STUDENTG20Srv.CustomerMessage")
...
try {
    ...
    customerMessages = await SELECT.from('HenryLin0610_STUDENTG20.CustomerMessage').forUpdate();
} catch (error) {
